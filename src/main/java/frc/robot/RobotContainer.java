...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    Trajectory firstTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        new Pose2d(2, 0, new Rotation2d(0)),    //should be going in meters
        forwardConfig);
    ...
    Trajectory secondTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        // Pass through these two interior waypoints, making an 's' curve path
        List.of(new Translation2d(1, 0), new Translation2d(0, 0.6)),//, new Translation2d(2, -1)),
        // End 3 meters straight ahead of where we started, facing forward
    ...
    return firstCommand.andThen(() -> swerveSubsystem.stopModules()).andThen(Commands.waitSeconds(1)).andThen(secondCommand).andThen(() -> swerveSubsystem.stopModules());
